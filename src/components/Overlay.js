  ...
  return (
    <div className="overlay">
      <a.svg viewBox="0 0 583 720" fill={fill} xmlns="http://www.w3.org/2000/svg">
        ...
        <svg width="30" height="30" viewBox="0 0 251 239" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <text style={{ whiteSpace: 'pre' }} fontSize={48} fontWeight="600" letterSpacing="-1">
          <tspan x={0} y={321.909}> Transforming the</tspan>
          <tspan x={0} y={372.909}>world one pixel</tspan>
          <tspan x={0} y={423.909}>at a time</tspan>
        </text>
        {/*<text styles={{ whiteSpace: 'pre' }} fontFamily="Inter" fontSize={10.5} fontWeight={500} letterSpacing="0em">*/}
