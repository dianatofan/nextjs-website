      ...
      <div className="w-screen mt-8 items-center animate__animated animate__fadeIn">
          ...
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
            ...
            <div className="max-w-screen-lg">
              ...
              <p className="text-lg mb-4">
                ...
                switching between pages during their trip planning, drowning in
                a sea of possibilities.
              </p>
              <p className="text-lg mb-8">
                Together with 3 UXDs and a UXR, we embarked on a design sprint
                journey to improve the search experience for travellers, making
                it easier to narrow down choices when planning a vacation.
              </p>
        ...
        <section className="bg-black text-white w-lg xl:flex items-center justify-center w-screen px-8 al">
          <div className="text-5xl antialiased tracking-tighter lg:leading-tight md:text-6xl text-white text-center font-semibold max-w-screen-md mx-auto py-32">
            ...
            <span className="text-tertiary"> when</span> to go by offering rich
            and inspiring experiences on Search
          </div>
        </section>
        <section className="bg-white py-12 flex items-center w-screen justify-center px-8">
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
          ...
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
            ...
            <div className="max-w-screen-lg">
              ...
              <p className="text-lg mb-4">
                ...
                starts her search by typing a broad query: “weekend getaway” to
                get started in her journey.
              </p>
              <p className="text-lg mb-8">
                First she is drawn to Grindelwald as it seems relaxing. After a
                quick peek, she thinks that it may not be kid-friendly and
              ...
              <p className="text-lg mb-8">
                She wants to check the map as she needs to make sure the travel
                time is manageable for the kids. She then discovers that London
                would be an affordable option. She wants to learn more.
              </p>
              <div className="flex justify-center">
                <Image
          ...
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
            ...
            <div className="max-w-screen-lg">
              ...
              <p className="text-lg mb-4">
                ...
                flight details by searching “flights to London”. However, she's
                also wondering: “are there other cheaper destinations?”, “am I
              ...
              <p className="text-lg mb-8">
                ...
                price and her search history, as well as sustainable suggestions
                to travel nearby.
              </p>
            </div>
          </div>
          ...
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
            ...
            <div className="max-w-screen-lg">
              ...
              <p className="text-lg mb-12">
                ...
                resume their search and find the information they need.
              </p>
              <h3 className="font-semibold uppercase text-gray-400 text-sm mb-4">
                Back to Naomi's story
              </h3>
              <p className="text-lg mb-4">
                Naomi considers a few potential destinations, but hasn’t made up
                her mind yet. She comes back to Search and types one of places
                in her mind, “London”; the search history page shows information
                about London, which she has searched for before
              </p>
              <div className="flex justify-center">
                <Image
              ...
              <p className="text-lg mb-8">
                She discovers that there is a Disney festival in London that her
                son would like. The flight is even cheaper than last time.
                London is calling.
              </p>
            </div>
          </div>
          ...
          <div className="xl:flex items-center justify-between w-screen max-w-screen-xl gap-6">
            ...
            <div className="max-w-screen-lg">
              <p className="text-lg mb-16">
                ...
                needs and interests. This framework can be extended to multiple
                scenarios, from weekend trips to ski tours or long summer
                vacations.
              </p>
              <div className="mb-8">
                ...
                <p className="text-lg mb-4">
                  ...
                  roadmap for 2024 planning, however there is stil a lot of work
                  left to do. Even if the concepts were validated by internal
                  stakeholders, we still need to conduct more user studies with
                  external participants to identify areas which might not seem
                  so counterintuitive to the average traveller.
                </p>
              </div>
            </div>
          </div>
