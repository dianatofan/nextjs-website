    ...
    <div className="xl:col-span-9 ">
      ...
      <div className="mt-10 max-w-5xl rounded-2xl border border-gray-200 bg-white overflow-hidden">
        <div className="relative w-full">
          <Image
            src="/images/canvas/workshop-compressed.png"
            alt="Workshop outputs mapping setup steps, constraints, and system dependencies."
            width={1920}
            height={1080}
            placeholder="blur"
            blurDataURL="data:image/jpeg;base64,"
